...
public final class MaterialAssignmentOrderSearchSpecifications {

    private MaterialAssignmentOrderSearchSpecifications() {
    }

    public static Specification<MaterialAssignmentOrder> assignedHistoryFrom(StockOrderHistorySearchCriteria criteria) {
