...
@Component
public class WorkOrderReportLocale {

    private static final String BUNDLE_BASE = "reports/work-order";

    @Value("${reports.work-order.locale:${reports.stock-assignment.locale:sr}}")
