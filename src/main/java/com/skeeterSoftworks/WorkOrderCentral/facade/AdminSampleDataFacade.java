...
public class AdminSampleDataFacade {
    ...
    /**
     * Inserts 10 demo rows each: machines, tools, products, customers, users (same rules as manual test).
     */
    ...
    public ResponseEntity<?> generate() {
        try {
            ...
            log.info(
                    "Sample data generated via API: {} machines, {} tools, {} products, {} customers, {} users",
